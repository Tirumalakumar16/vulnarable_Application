 ...
 <header class="bg-cyan-500  text-white">
   ...
   <div class="max-w-md mx-auto mt-10 p-8 bg-white shadow-lg rounded-xl">
    ...
    <form method="post" class="space-y-5">
        <!-- Username -->
        <div>
            <label  for="username" class="block text-md font-semibold text-gray-700 mb-1">Username:</label>
        ...
        <!-- Password -->
        <div>
            <label for="password" class="block text-md font-semibold text-gray-700 mb-1">Password:</label>
